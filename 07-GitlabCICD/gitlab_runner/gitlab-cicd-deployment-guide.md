...
This guide implements GitLab CI/CD using industry best practices for production Kubernetes environments, integrating with your existing infrastructure stack (Harbor, Longhorn, MetalLB, NGINX Ingress).
...
**Option 2: GitLab Runner Only (Recommended for Your Use Case)**
- Use GitLab.com or external GitLab instance for repository
- Deploy only runners in your cluster
- Lightweight: ~500MB-2GB RAM per runner
- Integrates with your Harbor registry
- **RECOMMENDED** - Best fit for your infrastructure
